...
#ifndef BRITREADY__LIFE_IN_UK_TEST_SWIFT_H
#define BRITREADY__LIFE_IN_UK_TEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BritReady__Life_in_UK_Test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
